...
public class GifSearcherEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (Target.OnSearchedTargetObject)
        {
            ...
            GUILayout.Label("Public method of (TenorFormattedResults results, Boolean nextPages).", EditorStyles.miniLabel);
            ...
            GUILayout.Label("Public method of (TenorFormattedResults results).", EditorStyles.miniLabel);
