...
public class LightUpInteractableNEVE : Interactable
{
    ...
    public override void Interact(GameObject interacter, Interactable interacted)
    {
        ...
        {
            if ((gameObject.GetComponent<Renderer>()) && (GameObject.Find("Disperso_gameplay").GetComponent<Disperso_neve>().GetisUsingPala() == true))
            {
